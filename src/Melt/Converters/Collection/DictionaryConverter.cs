...
namespace Melt
{
    ...
    public sealed class DictionaryConverter : InterfaceTypeConverter<IDictionary>
    {
        public override bool CanConvert(Type type) => base.CanConvert(type);
        protected override IDictionary OnConvertFromBytes(byte[] bytes, out int length, ConverterPool pool)
        {
        ...
        protected override byte[] OnConvertToBytes(IDictionary dict, ConverterPool pool)
        {
